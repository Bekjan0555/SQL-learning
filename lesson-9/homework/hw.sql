...
SELECT 
    ...
    s.SupplierName AS "Etkazib beruvchi nomi"
FROM Products p
...
SELECT 
    ...
    e.Name AS "Xodim ismi",
    e.Salary AS "Maoshi",
    e.HireDate AS "Ishga olish sanasi"
FROM Departments d
...
--4.
SELECT 
    CONCAT(c.FirstName, ' ', c.LastName) AS "Mijoz nomi",
    o.OrderID AS "Buyurtma ID",
    o.OrderDate AS "Buyurtma sanasi",
    o.TotalAmount AS "Umumiy summa",
    o.Quantity AS "Miqdori"
FROM Orders o
INNER JOIN Customers c ON o.CustomerID = c.CustomerID
ORDER BY c.FirstName, c.LastName, o.OrderDate;
--5.
SELECT 
    s.Name AS "Talaba ismi",
    s.Major AS "Mutaxassislik",
    c.CourseName AS "Kurs nomi",
    c.Instructor AS "O'qituvchi"
FROM Students s
...
SELECT 
    e.Name AS "Xodim ismi",
    e.EmployeeID AS "Xodim ID",
    d.DepartmentName AS "Bo'lim nomi",
    d.DepartmentID AS "Bo'lim ID",
    e.Salary AS "Maoshi",
    e.HireDate AS "Ishga olish sanasi"
FROM Employees e
...
SELECT 
    s.Name AS "Talaba ismi",
    s.StudentID AS "Talaba ID",
    s.Major AS "Mutaxassislik",
    e.CourseID AS "Kurs ID",
    e.EnrollmentID AS "Ro'yxatga olish ID"
FROM Students s
...
SELECT
    ...
    D.DepartmentName AS MismatchedDepartment
FROM
    Employees E
JOIN
...
SELECT 
    ...
    e1.DepartmentID AS DepartmentID1,
    e2.EmployeeID AS EmployeeID2,
    e2.Name AS EmployeeName2,
    e2.DepartmentID AS DepartmentID2
FROM 
    Employees e1
...
SELECT DISTINCT
    ...
    e2.Name AS SubordinateName,
    e2.Salary AS SubordinateSalary
FROM 
    Employees e1
